# @data_tests
# DE / Организация Data Lake / PySpark для инженера данных / Операции с DataFrame: кэширование и контрольные точки / Задание 2
...
_test.var_exists('df', 'df_library', 'df_join', 'df_cache', same_type=True, precode=True)

_test.call('setCheckpointDir')

_test.call('checkpoint', obj=_u.df_cache)
