# @data_tests
# DE / Организация Data Lake / PySpark для инженера данных / Автоматизация джобы / Задание 1
...
_test.call([
    dict(name='BashOperator'),
    dict(name='SparkSubmitOperator')
])

_test.var_exists('events_partitioned')

assert isinstance(
    _u.events_partitioned, (_BashOperator, _SparkSubmitOperator)
