# @data_tests
# DE / Организация Data Lake / PySpark для инженера данных / Операции с DataFrame: JOIN и UNION / Задание 4
...
_test.var('book_1', 'book_2', 'columns_1', 'columns_2', precode=True)
_test.var_exists('df_1', 'df_2', same_type=True, precode=True)

_test.call('unionByName')
