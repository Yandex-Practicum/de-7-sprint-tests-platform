# @data_tests
# DE / Организация Data Lake / PySpark для инженера данных / Операции с DataFrame: JOIN и UNION / Задание 3
...
_test.call("join", obj=_u.df, in_args=[_u.df_library, ["book_id"], "inner"])
_test.call("select", in_args=["title"])
_test.call("show", in_kwargs=dict(truncate=False))
