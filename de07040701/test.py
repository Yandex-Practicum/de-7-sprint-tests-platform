# @data_tests
# DE / Организация Data Lake / PySpark для инженера данных / Операции с DataFrame: кэширование и контрольные точки / Задание 1
...
_test.var_exists('df', 'df_library', 'df_join', same_type=True, precode=True)

_test.call('cache', obj=_u.df_join)
