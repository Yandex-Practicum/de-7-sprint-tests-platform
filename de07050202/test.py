# @data_tests
# DE / Организация Data Lake / Подготовка данных и наполнение Data Lake / Задача 1: обновление справочника тегов / Задание 2
...
_test.call('input_paths', in_args=['2022-05-31', 7], precode=True)

_test.var_exists('candidates')
