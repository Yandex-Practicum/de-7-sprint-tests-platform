...
def tag_tops(date, depth, spark):
    ...
    result = (
        spark.read.option("basePath", "/home/student/user/USERNAME/data/events")
...
def reaction_tag_tops(date, depth, spark):
    ...
    all_message_tags = (
        spark.read.parquet("/home/student/user/USERNAME/data/events")
    ...
    like_tops = (
        reaction_tops.where("reaction_type = 'like'")
        .drop("reaction_type")
    ...
    dislike_tops = (
        reaction_tops.where("reaction_type = 'dislike'")
        .drop("reaction_type")
...
result = calculate_user_interests("2022-05-04", 3, spark)